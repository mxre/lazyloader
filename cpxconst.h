...
typedef int CPXSIZE_BITS_TEST1[1 + (int) sizeof (CPXSIZE) -
                               (int) sizeof (size_t)];
typedef int CPXSIZE_BITS_TEST2[1 + (int) sizeof (size_t) -
                               (int) sizeof (CPXSIZE)];
#endif
#endif
...
#define CALLBACK_DELETENODE_ARGS CPXCENVptr xenv,\
  ...
  struct cpxiodevice
  {
    ...
    int (CPXPUBLIC * cpxiodev_puts) (const char *s, struct cpxiodevice * dev);
      size_t (CPXPUBLIC * cpxiodev_read) (void *ptr, size_t size,
                                          struct cpxiodevice * dev);
      size_t (CPXPUBLIC * cpxiodev_write) (const void *ptr, size_t size,
                                           struct cpxiodevice * dev);
  };
...
{
#endif
#define CPX_VERSION 12060300
#define CPX_VERSION_VERSION 12
#define CPX_VERSION_RELEASE 6
#define CPX_VERSION_MODIFICATION 3
...
product CPLEX, library cplex1263.lib, version 12.6.3.0, date 10/22/2015, \
Copyright IBM Corporation 1988, 2015. All Rights Reserved. \
US Government Users Restricted Rights - Use, duplication or \
disclosure restricted by GSA ADP Schedule Contract with IBM Corp."
#else
#define CPX_VERSIONSTRING "@(#)Licensed Materials - Property of IBM - 5725-A06 5725-A29 5724-Y48 5724-Y49 5724-Y54 5724-Y55 5655-Y21: \
product CPLEX, library libcplex.a, version 12.6.3.0, date 10/22/2015, \
Copyright IBM Corporation 1988, 2015. All Rights Reserved. \
US Government Users Restricted Rights - Use, duplication or \
disclosure restricted by GSA ADP Schedule Contract with IBM Corp."
#endif
...
#define CPX_SOLUTIONTARGET_AUTO CPX_OPTIMALITYTARGET_AUTO
#define CPX_SOLUTIONTARGET_OPTIMALCONVEX CPX_OPTIMALITYTARGET_OPTIMALCONVEX
#define CPX_SOLUTIONTARGET_FIRSTORDER CPX_OPTIMALITYTARGET_FIRSTORDER
#define CPX_SOLUTIONTARGET_OPTIMALGLOBAL CPX_OPTIMALITYTARGET_OPTIMALGLOBAL
...
#define CPX_PARAM_SOLUTIONTARGET 1148
...
#define CPXPARAM_SolutionTarget 1148
...
extern "C"
{
  ...
  struct cpxdeserializer
  {
    ...
    int (CPXPUBLIC * getbytes) (CPXDESERIALIZERptr deser, CPXLONG cnt,
                                CPXBYTE * b);
    int (CPXPUBLIC * getshorts) (CPXDESERIALIZERptr deser, CPXLONG cnt,
                                 CPXSHORT * s);
    int (CPXPUBLIC * getints) (CPXDESERIALIZERptr deser, CPXLONG cnt,
                               CPXINT * i);
    int (CPXPUBLIC * getlongs) (CPXDESERIALIZERptr deser, CPXLONG cnt,
                                CPXLONG * l);
    int (CPXPUBLIC * getfloats) (CPXDESERIALIZERptr deser, CPXLONG cnt,
                                 float *d);
    int (CPXPUBLIC * getdoubles) (CPXDESERIALIZERptr deser, CPXLONG cnt,
                                  double *d);
  };
  struct cpxserializer
  {
    ...
    int (CPXPUBLIC * addbytes) (CPXSERIALIZERptr ser, CPXLONG cnt,
                                CPXBYTE const *b);
    int (CPXPUBLIC * addshorts) (CPXSERIALIZERptr ser, CPXLONG cnt,
                                 CPXSHORT const *s);
    int (CPXPUBLIC * addints) (CPXSERIALIZERptr ser, CPXLONG cnt,
                               CPXINT const *i);
    int (CPXPUBLIC * addlongs) (CPXSERIALIZERptr ser, CPXLONG cnt,
                                CPXLONG const *l);
    int (CPXPUBLIC * addfloats) (CPXSERIALIZERptr ser, CPXLONG cnt,
                                 float const *d);
    int (CPXPUBLIC * adddoubles) (CPXSERIALIZERptr ser, CPXLONG cnt,
                                  double const *d);
  };
